---
title: "poli 198 - working code WI'21"
author: Sally Rong
...
## problem b/c then it's only changed for the obs'ns that == "ELEITO"
# select rather than filter won't work
```
...
# Merging datasets
```{r}
#testdf <- rbind(df2008, df2012)
#testdf2 <- rbind(testdf, df2004)
```
